<template>
  <div
    ...
    <div
      ...
      <p
        class="my-12 mt-2 text-2xl font-bold tracking-wider text-hd-primary-hover md:text-3xl lg:text-4xl">
        您訪問的頁面不存在
      </p>
      <router-link
        to="/"
        class="flex items-center space-x-2 rounded bg-hd-primary px-4 py-2 text-gray-100 transition duration-150 hover:bg-hd-primary-hover">
        <svg
    ...
    <div class="flex w-1/2 justify-center p-4 lg:h-full lg:items-end">
      <svg
        class="w-full text-hd-primary-hover"
        xmlns="http://www.w3.org/2000/svg"
        data-name="Layer 1"
